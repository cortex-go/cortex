...
if(!flat.includes('md-heading')||!flat.includes('md-gap')||!flat.includes('"STRONG"')||!flat.includes('"CODE"')||!flat.includes('"UL"'))throw new Error('Markdown smoke render incomplete');
