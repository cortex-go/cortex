...
function setTasksCollapsed(c){const s=active();if(!s)return;s.tasksCollapsed=c;renderTaskPanel(s)}$('#taskToggle').onclick=()=>setTasksCollapsed(true);$('#taskReopen').onclick=()=>setTasksCollapsed(false);
